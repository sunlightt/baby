...
Page({
    ...
    draw_img: function (context) {
        ...
        var qrcodeUrl = '../../img/draw_img2.png';
    ...
    draw_table_content: function (context) {
        ...
        context.fillText(study_day_num, 40, 431);
        ...
        context.fillText(over_partner, 128, 431);
        ...
        context.fillText(resouce_progress, 218, 431);
        ...
        context.fillText(small_font1, 244, 441);
